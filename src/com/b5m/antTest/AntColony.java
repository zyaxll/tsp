...
public class AntColony {
    ...
    protected TSP tsp;
    protected double[][] dists;    //�ڵ��ľ���
    protected double[][] nears;
    protected double[][] trail;    //���ϵ���Ϣ��
    protected double[][] delta;    //��Ϣ�ر仯��
    protected double[][] quals;   //�ߵ�Ȩֵ
    protected boolean[] visited;   //�Ƿ���ʹ�
    protected int[] tour;    //��ǰ������������·��
    protected double len;      //��ǰ������������·���ĳ���
    protected int[] brun;
    ...
    protected int antcnt;   //һ�ε��������ϵ�����
    protected int epoch;    //��ǰ��������
